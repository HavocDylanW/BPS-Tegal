                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span
                                    class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Tugas</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                            ...
                            @foreach ($assignments as $assignment)
                                <tr
                                    ...
                                    <td class="px-4 py-4 text-center">
                                        {{ $assignment->submissions->where('approval_status', 1)->sum('realisasi') ?? 'N/A' }}
                                    </td>
                                        ...
                                        @if (Auth::user()->roles->contains('name', 'Admin') || Auth::user()->roles->contains('name', 'Employee'))
                                            <div> <!-- Add margin-bottom for spacing -->
                                                <a href="{{ route('submissions.create', ['assignment' => $assignment->id]) }}"
                                                    class="px-3 py-2 text-sm inline-flex items-center font-medium text-center text-white bg-blue-700 rounded-md hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</a>
                                            </div>
                                        @endif
                                        @if (Auth::user()->roles->contains('name', 'Admin'))
                                            <div>
                                                <a href="{{ route('assignments.edit', $assignment->id) }}"
                                                    class="px-3 py-2 text-sm inline-flex items-center mt-2 font-medium text-center focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 rounded-md dark:focus:ring-yellow-900">Komentar</a>
                                            </div>
                                        @endif
                                    </td>
                                </tr>
