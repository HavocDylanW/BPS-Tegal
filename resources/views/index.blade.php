...
@section('content')
    <section class="mt-4 mb-2 px-2 sm:px-20">
        <div id="alert-additional-content-1"
            ...
            <div class="flex items-center">
                ...
                <h3 class="text-lg font-medium">Selamat Datang di Sistem Monitoring SAKIP Tegal {{ Auth::user()->name }}!
                </h3>
            </div>
    ...
    <section class="px-2 sm:px-20">
        <p class="text-4xl mt-5 mb-5 sm:mb-10 font-bold text-gray-900 dark:text-white">Dashboard</p>
        <div class="md:flex md:col md:columns-3 gap-5 grid grid-rows-1">
            <div
                class="w-full p-6 drop-shadow-2xl bg-[#ABBA7C] border border-[#3D5300] rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <h5 class="mb-2 text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Total seluruh tugas</h5>
                <h5 class="mb-3 text-7xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $userAssignmentCount }}
                </h5>
            </div>
            <div
                class="w-full p-6 drop-shadow-2xl bg-[#FFBD73] border border-[#F09319] rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <h5 class="mb-2 text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Total tugas yang sudah
                    di
                    kerjakan</h5>
                <h5 class="mb-3 text-7xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $userSubmissionCount }}
                </h5>
            </div>
            <div
                class="w-full p-6 drop-shadow-2xl bg-[#ABBA7C] border border-[#3D5300] rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <h5 class="mb-2 text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Nama Team</h5>
                <h5 class="mb-3 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">
    ...
    <section class="mt-5 mb-7 px-2 sm:px-20">
        <div class="max-w-full w-full bg-white drop-shadow-2xl rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
            <div class="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    <div class="w-12 h-12 rounded-lg bg-[#99c24d] dark:bg-gray-700 flex items-center justify-center me-3">
                    ...
                    <div>
                        <h5 class="leading-none text-lg md:text-2xl font-bold text-gray-900 dark:text-white pb-1">Progress
                            Realisasi
                ...
                <div>
                    <span
                        class="bg-[#f18f01] text-black text-xs font-medium inline-flex items-center px-2.5 py-1 rounded-md dark:bg-green-900 dark:text-green-300">
            ...
            <div class="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between">
                <div class="flex justify-between items-center pt-5">
                    ...
                    {{-- <div class="inline-flex items-center dark:hover:text-white">
                        <label for="quarterSelect" class="sr-only">Select Quarter</label>
                        <select id="quarterSelect"
                            class="uppercase w-full text-sm font-medium text-[#99c24d] dark:text-gray-400 hover:text-gray-900 text-center bg-transparent border-0 border-gray-200 appearance-none dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer"
                            onchange="window.location.href='?quarter=' + this.value;">
                            <option value="" disabled selected>Choose a quarter</option>
                            <option value="1" {{ $quarter == 1 ? 'selected' : '' }}>January - March</option>
                            <option value="2" {{ $quarter == 2 ? 'selected' : '' }}>April - June</option>
                            <option value="3" {{ $quarter == 3 ? 'selected' : '' }}>July - September</option>
                            <option value="4" {{ $quarter == 4 ? 'selected' : '' }}>October - December</option>
                    ...
                    {{-- <button id="dropdownDefaultButton" data-dropdown-toggle="lastDaysdropdown"
                        ...
                        class="text-sm font-medium text-[#99c24d] dark:text-gray-400 hover:text-gray-900 text-center inline-flex items-center dark:hover:text-white"
                        type="button">
                        Last 7 days
                    ...
                    <a href="#"
                        class="uppercase text-sm font-semibold inline-flex items-center rounded-lg text-[#99c24d] hover:text-blue-700 dark:hover:text-blue-500  hover:bg-gray-100 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 px-3 py-2">
                        Leads Report
