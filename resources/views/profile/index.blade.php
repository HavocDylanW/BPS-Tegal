...
@section('content')
    <section class="p-10 grid grid-cols-1 md:gap-6 md:grid-cols-3">
        <div class="max-w-sm pt-8 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="flex flex-col items-center pb-10">
                <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="{{ asset('profile/templates/woman.jpeg') }}"
                    alt="Bonnie image" />
        ...
        <div
            class="md:col-span-2 max-w-full w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <form>
